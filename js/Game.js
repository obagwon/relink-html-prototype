...
export class Game {
  ...
  runSelfTest(){
    ...
    try{
      ...
      const y=this.player.root.position.y;this.player.grounded=true;this.player.bounce(8);this.player.update(1/60,this.cameraController,this.world);check('jump',this.player.root.position.y>y);
